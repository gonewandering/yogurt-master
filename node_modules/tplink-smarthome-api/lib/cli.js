...
function getClient() {
    ...
    if (commander_1.default.udp)
        defaultSendOptions.transport = 'udp';
    if (commander_1.default.timeout)
        defaultSendOptions.timeout = commander_1.default.timeout;
        ...
        getClient()
            ...
            if (sysInfo) {
                console.dir(device.sysInfo, {
                    colors: commander_1.default.color === 'on',
                    depth: 10,
                });
            }
        });
...
async function send(host, port, payload) {
    try {
        ...
        console.dir(data, { colors: commander_1.default.color === 'on', depth: 10 });
    }
    catch (err) {
        outputError(err);
    }
...
async function sendCommand(host, port, childId, payload) {
    try {
        ...
        console.log('response:');
        console.dir(results, { colors: commander_1.default.color === 'on', depth: 10 });
    }
    catch (err) {
        outputError(err);
    }
...
async function details(host, port) {
    try {
        ...
        console.dir({
            ...
            mac: device.mac,
        }, { colors: commander_1.default.color === 'on', depth: 10 });
    }
    catch (err) {
        outputError(err);
    }
...
commander_1.default
    ...
    search(options.sysinfo, options.breakoutChildren || false, commander_1.default.timeout, options.broadcast, paramsObj);
});
commander_1.default
